...
class Zoom_api
{
    ...
    protected function sendRequest($data)
    {
// var_dump($this->generateJWTKey()); die;
        $request_url = 'https://api.zoom.us/v2/users/me/meetings';
        $headers = array(
    ...
    public function createAMeeting($data = array())
    {
        ...
        // echo "<pre>";print_r($createAMeetingArray);exit;
    ...
    public function twilioAcnt(){
        ...
        $sid = getenv("AC9c61b4a1601d9055e672e2e79179cd1a");
        $token = getenv("456539a356bf5f46a607d1f3b73b1d24");
