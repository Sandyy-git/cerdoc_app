...
{   
    ...
    public function get($id = null)
    {
        ...
        if ($id != null) {
            ...
            $this->db->where('item_stock.added_by', $added_by);
        } else {
    ...
    public function getAllitemstockRecord()
    {
        ...
        $this->datatables
            ...
            ->where('item_stock.added_by', $added_by)
            ->from('item_stock');
