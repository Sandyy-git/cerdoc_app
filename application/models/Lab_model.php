...
class Lab_model extends MY_model
{
    ...
    public function getradioparameter($id = null)
    {
        ...
        if (!empty($id)) {
            ...
            $this->db->join('unit', 'radiology_parameter.unit = unit.id', 'left');
            //na
         $this->db->where('radiology_parameter.added_by', $staffRoles_id);
        //  $this->db->or_where('radiology_parameter.is_central_pharm', 'yes');
         //ne
    ...
    public function getlabName($id = null)
    {
        ...
        if (!empty($id)) {
            ...
            return $query->row_array();
             ...
             //na
         $this->db->where('lab.added_by', $staffRoles_id);
        //  $this->db->or_where('lab.is_central_pharm', 'yes');
         //ne
    ...
    public function getunit($id = null)
    {
        ...
        if (!empty($id)) {
            ...
            $this->db->where('unit_type', 'radio');
            //na
         $this->db->where('unit.added_by', $staffRoles_id);
        //  $this->db->or_where('unit.is_central_pharm', 'yes');
         //ne
            $query = $this->db->get('unit');
            return $query->result_array();
        }
