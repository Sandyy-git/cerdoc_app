...
class Prescription_model extends MY_Model
{
    ...
    {
        //FIRST VARUN CREATED 
        // $query  = $this->db->select("visit_details.*,opd_details.id as opdid,patients.id as patientid ,patients.patient_name,patients.id as patient_unique_id,patients.age,patients.month,patients.day,patients.gender,patients.address,patients.blood_group,staff.name,staff.surname,staff.employee_id,staff.local_address")
        ...
        // ->where("visit_details.id", $visitid)->get("visit_details");
        // $result = $query->row_array();
        // return $result;
        //CREATED BY ME
        $query  = $this->db->select("visit_details.*,opd_details.id as opdid,patients.id as patientid ,patients.patient_name,patients.id as patient_unique_id,patients.age,patients.month,patients.day,patients.gender,patients.address,patients.blood_group,staff.name,staff.surname,staff.employee_id,staff.local_address,ipd_prescription_basic.ipd_id,ipd_prescription_basic.id as prescription_id,ipd_prescription_basic.date as presdate,ipd_prescription_basic.header_note,ipd_prescription_basic.footer_note,ipd_prescription_basic.finding_description,ipd_prescription_basic.is_finding_print,ipd_prescription_basic.manual_prescription,ipd_prescription_basic.mp_image,ipd_prescription_basic.opd_logo")
        ->join("visit_details", "visit_details.id = ipd_prescription_basic.visit_details_id","left")
        ->join("opd_details", "opd_details.id = visit_details.opd_details_id", "inner")
        ->join("patients", "patients.id = opd_details.patient_id", 'left')
        ->join("staff", "staff.id = visit_details.cons_doctor")
        ->where("ipd_prescription_basic.manual_prescription", 'yes')
    ...
    public function add_ipdprescription($ipd_basic_array, $insert_ipd_prescription_details, $update_ipd_prescription_details, $not_be_deleted_medicines, $pathology, $radiology,$delete_pathology, $delete_radiology, $ipd_prescription_basic_id)
    {
        ...
        // var_dump($ipd_basic_array['id']);
        // var_dump($not_be_deleted_medicines);
        // var_dump($insert_ipd_prescription_details);      //from insert_medicine array
        // var_dump($update_ipd_prescription_details);
        // var_dump($delete_pathology);
        // var_dump($pathology); 
        // var_dump($delete_radiology);
        // var_dump($radiology); 
        // die;


        // var_dump($ipd_basic_array['id']); die;                             //1
        ...
        // var_dump($insert_ipd_prescription_details); die;                             //array(0)
        ...
        // var_dump($pathology); die;                             //array(0)
