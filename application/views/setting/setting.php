            ...
            <form action="<?php echo site_url('admin/admin/updateandappCode') ?>" method="POST" id="andapp_code">
                <div class="modal-body andapp_modal-body">
                    ...
                    <div class="form-group">
                        <label class="ainline"><span>ehealthflex Market Purchase Code for Smart Hospital Android App ( <a target="_blank" href="https://help.market.ehealthflex.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-"> How to find it?</a> )</span></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Your Email registered with ehealthflex</label>
