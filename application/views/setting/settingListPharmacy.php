                        ...
                        <form role="form" id="schsetting_form" action="<?php echo site_url('schsettings/ajax_schedit') ?>" class="" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('medicalstore_name'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('medicalstore_code'); ?></label>
                                            <div class="col-sm-8">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('medicalstore_logo'); ?><small class="req"> *</small></label>
                                         <?php
                                    ...
                                    <div class="col-md-6">
                                         <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('medicalstore_small_logo'); ?><small class="req"> *</small></label>
                                            <?php
