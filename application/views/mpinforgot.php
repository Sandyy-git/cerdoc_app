                    ...
                    <div class="loginbg">
                        <div class="form-top">
                            <div class="form-top-left">
                                <h3 class="font-white">Reset Mpin</h3>
                        ...
                        <div class="form-bottom">
                            ...
                            ?>
                            <form class="" action="<?php echo site_url('site/mpinforgot') ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" placeholder="<?php echo $this->lang->line('mobile_no'); ?>" class="form-username form-control" id="form-username">
