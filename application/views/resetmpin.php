                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="loginbg">
                        ...
                        <div class="form-bottom">
                            ...
                            ?>
                            <form action="<?php echo site_url('site/resetmpin/' . $role . '/' . $verification_code) ?>" method="post">
                                <?php echo $this->customlib->getCSRF(); ?>
                                <div class="form-group">
                                    <label class="sr-only">Mpin</label>
                                    <input type="password" name="mpin" placeholder="Enter mpin" class="form-password form-control" id="form-password">
                                    <span class="text-danger"><?php echo form_error('mpin'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label class="sr-only">Confirm Mpin</label>
                                    <input type="password" name="confirm_mpin" placeholder="Confirm Mpin" class="form-control" id="form-confirm_password">
                                    <span class="text-danger"><?php echo form_error('confirm_mpin'); ?></span>
                                </div>
                                <button type="submit" class="btn"><?php echo $this->lang->line('submit'); ?></button>
                            </form>
                            <a href="<?php echo site_url('site/mpinlogin') ?>" class="forgot"><i class="fa fa-key"></i> Login </a>
                        </div>
                    </div>
                </div>
            </div>
