                ...
                <div class="col-lg-5 col-sm-5 <?php echo $offset; ?> form-box">
                    <div class="loginbg">
                        ...
                        <div class="form-bottom">
                            ...
                            ?>
                            <form action="<?php echo site_url('site/mpinlogin') ?>" method="post">
                                <?php echo $this->customlib->getCSRF(); ?>
                                <div class="form-group">
                                    <label class="sr-only" for="form-username">
                                       Enter Username</label>
                                    <input type="text" name="username" placeholder="Enter your Username" class="form-username form-control" id="mpin"> <span class="text-danger"><?php echo form_error('username'); ?></span>
                                </div>

                                <div class="form-group">
                                    <label class="sr-only" for="form-username">
                                       Enter Mpin</label>
                                    <input type="text" name="mpin" placeholder="Enter your mpin" class="form-username form-control" id="mpin"> <span class="text-danger"><?php echo form_error('mpin'); ?></span>
                                </div>
                                <?php if($is_captcha){ ?>
                            ...
                            <br>
                            <p><a href="<?php echo site_url('site/mpinforgot') ?>"  class="forgot"> <i class="fa fa-key"></i> Reset Mpin</a> </p>
                        </div>
                    </div>
                </div>
                <?php
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.login-form input[type="text"], .login-form input[type="mpin"], .login-form textarea').on('focus', function () {
            $(this).removeClass('input-error');
        });
        $('.login-form').on('submit', function (e) {
            $(this).find('input[type="text"], input[type="mpin"], textarea').each(function () {
                if ($(this).val() == "") {
                    e.preventDefault();
