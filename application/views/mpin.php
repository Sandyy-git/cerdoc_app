                    ...
                    <div class="loginbg">
                        <div class="form-top">
                            <div class="form-top-left">
                                <h3 class="font-white">Setup Mpin</h3>
                            </div>
                        ...
                        <div class="form-bottom">
                            ...
                            ?>
                            <form action="<?php echo site_url('user/mpin/' . $role . '/' . $verification_code) ?>" method="post">
                                <?php echo $this->customlib->getCSRF(); ?>
                                <div class="form-group">
                                    <label class="sr-only">Mpin</label>
                                    <input type="text" name="mpin" placeholder="Enter mpin" class="form-password form-control" id="form-password">
                                    <span class="text-danger"><?php echo form_error('mpin'); ?></span>
                                </div>

                                <button type="submit" class="btn"><?php echo $this->lang->line('submit'); ?></button>
                            </form>
                            <a href="<?php echo site_url('site/mpinlogin') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('user_login'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
