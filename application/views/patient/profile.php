...
<div class="modal fade" id="mpprescriptionview" tabindex="-1" role="dialog" aria-labelledby="follow_up">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<script type="text/javascript">
    ...
    // ADD MANUAL PRESCRIPTION
    $('#mpprint_id').show();
    function mpprint(id, opdid) {
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/prescription/getPrescriptionmanual/' + id,
            type: 'POST',
            data: {payslipid: id,print:'print'},
            success: function (result) {
                $("#testdata").html(result);
