...
$(document).on('input','.chat_input',function(){
    ...
    function newChatMessage() {
        ...
        //alert(chat_connection_id);      //from chat_connections table //id - 20
        var chat_to_user = $("input[name='chat_to_user']").val();
        //alert(chat_to_user);            //from chat_connections table  //id - 9

        if (chat_connection_id > 0 && chat_to_user > 0) {

            $.ajax({
                type: "POST",
                url: baseurl + 'patient/chat/newMessage',         //message insertion to chat_messages table
