productwisesalesreport.php<style type="text/css">
    @media print
    {
        .no-print, .no-print *
        {
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('chemist_productwise_purchase_report') ?></h3>
            ...
            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('purchase_id'); ?></th>
                ...
                <tr>
                    ...
                    <!-- <td><?php echo $dt_value['supplier'] ?></td> -->
                    
                    <td><?php echo $dt_value['purchase_id']; ?></td>
                    <td><?php echo $dt_value['batch_no']; ?></td>
                     <td><?php echo $dt_value['expiry']; ?></td>
