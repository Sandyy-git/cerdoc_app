            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('chemist_purchase_report') ?></h3>
            ...
            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('to_chemist'); ?></th>
                ...
                <tr>
                    ...
                    <td class="text text-right"><?php echo $dt_value['bill_id']; ?></td>
                    ...
                    <td class="text text-right"><?php echo amountFormat($dt_value['total']); ?></td>
