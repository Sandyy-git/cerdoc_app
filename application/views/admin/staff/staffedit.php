                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input readonly="<?php if($this->rbac->hasAccess())  ?>" autofocus="" id="employee_id" name="employee_id" placeholder="" value="<?php echo $staff["employee_id"] ?>" type="text" class="form-control"  value="" />
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select readonly="<?php if($this->rbac->hasAccess())  ?>" id="role" name="role" class="form-control" >
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select readonly="<?php if($this->rbac->hasAccess())  ?>" id="designation" name="designation" placeholder="" type="text" class="form-control" >
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select readonly="<?php if($this->rbac->hasAccess())  ?>" id="department" name="department" placeholder="" type="text" class="form-control" >
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="date_of_joining" name="date_of_joining" placeholder="" type="text" class="form-control date" readonly="<?php if($this->rbac->hasAccess())  ?>" value="<?php if ($staff["date_of_joining"] != '0000-00-00' && $staff["date_of_joining"]!="") {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label><?php
                                                    ...
                                                    echo $this->lang->line('local_identification_number');
                                                }else{
                                                    echo "Medical Registration Id" ;
                                                }
                                               ?></label>
                                                <?php
                                                if (!$this->rbac->hasAccess()) {
                                                    echo '<small class="req">';
                                                    echo '*';
                                                    echo "</small>";
                                                ...
                                                <span class="text-danger"><?php echo form_error('local_identification_number'); ?></span></div>
                                        </div>
                                       
                                        <!-- <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('pincode'); ?></label><small class="req"> *</small>
                                                <input id="pincode" name="pincode" placeholder="" type="text" class="form-control"  value="<?php echo $staff["pincode"] ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="specialistOpt" name="locality_id" placeholder="" type="text" class="form-control" onchange="appendCity(this)">
                                                    <?php foreach ($stafflocality as $key => $slvalue) {
                                                        if ($staff["locality_id"] == $slvalue["id"]) {
                                                        ?>
                                                        <option selected value="<?php echo $slvalue["id"] ?>" <?php echo set_select('staff_locality', $slvalue['id'], set_value('staff_locality')); ?>><?php echo $slvalue["locality"] ?></option>
                                                        <?php }else{ ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="city" name="city" placeholder="" type="text" class="form-control"  value="<?php echo $staff["city"] ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="gst_in" name="gst_in" placeholder="" type="text" class="form-control"  value="<?php echo $staff["gst_in"] ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="drug_license_number" name="drug_license_number" placeholder="" type="text" class="form-control"  value="<?php echo $staff["drug_license_number"] ?>" />
