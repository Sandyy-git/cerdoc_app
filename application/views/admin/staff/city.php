            ...
            <div class="col-md-10">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('locality_city_list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('locality_city', 'can_add')) { ?>
                                <a onclick="addModal()" class="btn btn-primary btn-sm medicine"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_locality_city'); ?></a> 
                            <?php } ?>    
                        </div>
                    </div> 
                    <div class="box-body">
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_locality_city'); ?></h4> 
            </div>
            <form id="formadd" action="<?php echo site_url('admin/city/add') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                    ...
                    <div class="modal-body pt0 pb0">
                        <div class="ptt10">
                            <div class="form-group">
                                ...
                                <select name="locality" placeholder=""  onchange="getMedicineName(this.value)" type="text" class="form-control">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    <?php foreach ($localityCity as $key => $catvalue) {
                                        ?>
                                        <option value="<?php echo $catvalue["id"] ?>"><?php echo $catvalue["locality"] ?></option>
                                    <?php } ?>
                                </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-5"> 
                                        <div class="form-group">
                                            ...
                                            <input autofocus="" name="city" placeholder="" type="text" class="form-control"/>
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/city/add') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">

                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('staff_locality'); ?></label><small class="req"> *</small>
                            <select name="locality" id="locality" placeholder=""  onchange="editMedicineName(this.value)" type="text" class="form-control">
                                <option value=""><?php echo $this->lang->line('select') ?></option>
                                <?php foreach ($localityCity as $key => $catvalue) {
                                    ?>
                                    <option value="<?php echo $catvalue["id"] ?>"><?php echo $catvalue["locality"] ?></option>
                        ...
                        <div class="col-sm-4"> 
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('city'); ?></label>
                                <small class="req"> *</small>
                                <input autofocus="" name="cityid" id="cityid" placeholder="" type="hidden" class="form-control"   />
                                <input autofocus="" name="city" id="city" placeholder="" type="text" class="form-control"   />
                            </div> 
                        </div> 
...
<script>
    ...
    function delete_medicine_dosage(id){
        delete_recordByIdReload('admin/city/delete/'+id, '<?php echo $this->lang->line('delete_confirm'); ?>');
    }
</script>