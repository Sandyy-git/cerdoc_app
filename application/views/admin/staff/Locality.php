                ...
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php if ($this->rbac->hasPrivilege('assign_pincodes', 'can_view')) { ?>
                            <li><a href="<?php echo base_url(); ?>admin/city" class="active"><?php echo $this->lang->line('assign_pincodes'); ?></a></li>
                        <?php } ?>  
                        <?php if ($this->rbac->hasPrivilege('assign_pincodes', 'can_view')) { ?>
            ...
            <div class="col-md-10">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('locality_list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('staff_locality', 'can_add')) { ?>
                                <a data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm specialist"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add_locality'); ?></a>    
                            <?php } ?> 
                        </div>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped ajaxlist" id="">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('locality'); ?></th>
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_locality'); ?></h4> 
            </div>

            <form id="formadd" action="<?php echo site_url('admin/locality/add') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('staff_locality'); ?></label><small class="req"> *</small>
                            <input autofocus="" id="type"  name="locality" placeholder="" type="text" class="form-control"  />
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/locality/edit') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('staff_locality'); ?></label><small class="req"> *</small>
                            <input autofocus="" id="type1"  name="locality" placeholder="" type="text" class="form-control"   />
                            <span class="text-danger"><?php echo form_error('staff_locality'); ?></span>

                            <input autofocus="" id="dept_id"  name="localityid" placeholder="" type="hidden" class="form-control"   />
                        </div>
                    </div>
                </div><!--./modal-->    
                <div class="modal-footer">
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/locality/getlocalitydatatable');
    });
} ( jQuery ) )
</script>
<!-- //========datatable end===== --> 
<script>
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: '<?php echo base_url(); ?>admin/locality/get_data/' + id,
            success: function (result) {
                $('#dept_id').val(result.id);
                $('#type1').val(result.locality);
            }
    ...
    {
        delete_recordById('admin/locality/localitydelete/' + id, '<?php echo $this->lang->line('delete_confirm') ?>');
    }
