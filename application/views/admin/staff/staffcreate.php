...
<script src="<?php echo base_url(); ?>backend/multiselect/js/date.js" ></script>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" placeholder="" type="text" class="form-control date disableFuturedate"  value="<?php echo set_value('dob') ?>" />
