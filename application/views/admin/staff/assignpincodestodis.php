                            ...
                            <table class="table table-striped table-bordered table-hover example" >
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('distributors'); ?></th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('locality_city', 'can_delete')) {
                                                        ?>
                                                        <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_dis_pincode('<?php echo $value['id'] ?>')">
    ...
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('add_pincodes_to_dis'); ?></h4> 
            </div>
            <form id="formadd" action="<?php echo site_url('admin/assignpincodes/addPincodestoDis') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                
                <div class="scroll-area">
                    <div class="modal-body pt0 pb0">
                        <div class="ptt10">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('distributors'); ?></label><small class="req"> *</small>
                                <select name="staff_id" placeholder=""  onchange="getMedicineName(this.value)" type="text" class="form-control">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    <?php foreach ($staffPincodes as $key => $catvalue) {
                                        ?>
                                        <option value="<?php echo $catvalue["id"] ?>"><?php echo $catvalue["name"] ?></option>
                                    <?php } ?>
                                </select>
                                <span class="text-danger"><?php echo form_error('distributors'); ?></span>
                            </div>
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/assignpincodes/addPincodestoDis') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">

                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('staff_locality'); ?></label><small class="req"> *</small>
                            <select name="staff_id" id="staff_id" placeholder=""  onchange="editMedicineName(this.value)" type="text" class="form-control">
                                <option value=""><?php echo $this->lang->line('select') ?></option>
                                <?php foreach ($staffPincodes as $key => $catvalue) {
                                    ?>
                                    <option value="<?php echo $catvalue["id"] ?>"><?php echo $catvalue["name"] ?></option>
                        ...
                        <div class="col-sm-4"> 
                            <div class="form-group">
                                ...
                                <small class="req"> *</small>
                                <input autofocus="" name="dispincodeid" id="dispincodeid" placeholder="" type="hidden" class="form-control"   />
...
<script> 
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>admin/assignpincodestodis/get_data_disPincode/' + id,

            success: function (result) {
                $('#dispincodeid').val(result.id);
...
<script>
    ...
    function addModalGloPincodes(){
        $("#myModalGloPincodes").modal("show");
        $("div").remove(".dosage_row");
    }

    

    function delete_dis_pincode(id){
        delete_recordByIdReload('admin/assignpincodestodis/delete/'+id, '<?php echo $this->lang->line('delete_confirm'); ?>');
    }
</script>