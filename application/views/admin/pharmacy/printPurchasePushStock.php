            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td align="text-left"><h5><label><?php echo $this->lang->line('stock_bill_no'); ?> </label> : <?php echo $this->customlib->getSessionPrefixByType('purchase_no').$result["id"] ?></h5>
                            </td>
                            ...
                            <td align="text-center"><h6><?php echo $result_supp["supplier"].','.$result_supp["contact"].','.$result_supp['address'].','.$result_supp["drug_license_number"].','.$result_supp["gst_in"]?></h6>
                            </td>
                    ...
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <th align="left"><?php echo $this->lang->line('address'); ?></th>
                                <td align="left"><?php echo $result['address']; ?></td> 
                                <th align="left"><?php echo $this->lang->line('dispatch_through'); ?></th>
                                <td align="left"><?php echo $result["dispatch_through"]; ?></td>
                                <th align="left"><?php echo $this->lang->line('drug_license_number'); ?></th>
                                <td align="left"><?php echo $result["drug_license_number"]; ?></td>
                                <th align="left"><?php echo $this->lang->line('gst_in'); ?></th>
                                <td align="left"><?php echo $result["gst_in"]; ?></td>
                                
                            </tr>
                            <!-- <tr>
                                <th width="20%"><?php echo $this->lang->line('dispatch_through'); ?></th>
                                <td width="25%"><?php echo $result["dispatch_through"]; ?></td>
                    ...
                    <div class="table-responsive">
                       <table class="printablea4" id="testreport" width="100%">
                        <tr>
                            ...
                            <th style="text-align: right;"><?php echo $this->lang->line('batch_qty'); ?></th> 
                        ...
                        foreach ($detail as $bill) {
                            ...
                            <tr>
                                ...
                                <td width=""><?php if($bill["medicine_category"] == "Generic"){ echo $bill["medicine_name"].' '; ?><?php echo $bill["generic_name"]; }else{ echo $bill["medicine_name"]; } ?></td>
