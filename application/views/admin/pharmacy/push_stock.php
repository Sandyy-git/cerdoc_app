            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('push_stock_list'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('push_stock', 'can_add')) { ?>
                                <a data-toggle="modal" onclick="holdModal('myModal')" class="btn btn-primary btn-sm addpurchase"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_stock'); ?></a> 
                            <?php } ?>

                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('push_stock_list'); ?></div>
                        <table class="table table-striped table-bordered table-hover ajaxlist" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('push_stock_list'); ?>">
                            <thead>
                                <tr>
                 ...
                 <div class="row">
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-9">
                     <div class="p-2 select2-full-width">
                        <select name="supplier_id" class="form-control select2 supplier_select2"  id="" name='' onchange="get_state_of_supplier(this.value)">
                         ...
                         <input type="hidden" name="gst_partition" id="gst_partition">
                         <!-- <input type="hidden" name="from_supplier_city" id="from_supplier_city"> -->
                                    ...
                                    <div class="col-md-12 mt10">
                                        <div class="table-responsive">
                                            <table class="table tableover table-striped table-bordered table-hover mb10 tablefull12" id="tableID">
                                                ...
                                                <tr class="white-space-nowrap">
                                                    ...
                                                    <th  width="10%"><?php echo $this->lang->line('search_type'); ?><small class="req"> *</small></th>
                                                    ...
                                                    <th><?php echo $this->lang->line('batch_qty') ;  ?></th>
                                                    ...
                                                    <th width="7%"><?php echo $this->lang->line('tax'); ?><small class="req"> *</small></th>
                                                ...
                                                <tr id="row0" class="white-space-nowrap">
                                                    <td>      
                                                        <select class="form-control" name='medicine_category_id[]' id="medicine_category_id_0">
                                                    ...
                                                    <td>      
                                                        <select class="form-control" name='search_type[]'  onchange="getmedicine_name_to_push_stock(this.value, '0')">
                                                    ...
                                                    <td>
                                                        <select class="form-control select2" style="width:100%" onchange="getmedicinedetailstoPushStock(this.value, 0)" id="medicine_name0" name='medicine_name[]'>
                                                            <option value=""><?php echo $this->lang->line('select'); ?>
                                                            </option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('medicine_name[]'); ?>
                                                        <input type="hidden" id="medicine_id0" name="medicine_id[]">
                                                        <input type="hidden" id="medicine_quantity0" name="medicine_quantity[]">

                                                    </td>
                                                    <!-- <td>
                                                        <input type="text"  name="batch_no[]"  id="batchno" class="form-control batch_no">
                                                        <span class="text-danger"><?php echo form_error('batch_no[]'); ?>
                                                        </span>
                                                    </td> -->

                                                    <td>
                                                      <select class="form-control batch_no select3" style="width:100%" id="batchno0" name="batch_no[]" onchange="getmedicinedetailstoPushStockById(this.value, 0)">
                                                    ...
                                                    <td>
                                                        <!-- na -->
                                                        <input type="text"  name="mrp[]"  id="mrp0" class="form-control" readonly>
                                                        <span class="text-danger"><?php echo form_error('mrp[]'); ?>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <input type="text" name="batch_amount[]" id="batch_amount0" class="form-control" readonly>
                                                        <span class="text-danger"></span>
                                                    </td>
													
                                                    <td>
                                                        <input type="text"  name="sale_rate[]"  id="sale_price0" class="form-control" readonly>
                                                        <span class="text-danger"><?php echo form_error('sale_rate[]'); ?>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <input type="text"  name="packing_qty[]"  id="packing_qty0" class="form-control" readonly>
                                                    ...
                                                    <td class="text-right">
                                                        <input type="text" name="purchase_price[]" onchange="multiply(0)" id="purchase_price0" placeholder="" class="form-control text-right" readonly>
                                                    ...
                                                    <td class="text-right">
                                                        <div class=""> 
                                                                <div class="input-group">
                                                                    <!-- na -->
                                                                <input type="text" onchange="multiply(0)" class="form-control right-border-none"  name="purchase_tax[]" id="purchase_tax0"  autocomplete="off" readonly>
                                        ...
                                        <div class="row">  
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group">  
                                                    <?php echo $this->lang->line('dispatch_through'); ?>
                                                    <input name="dispatch_through" rows="3" id="dispatch_through" class="form-control">
                                                    <span class="text-danger"><?php echo form_error('dispatch_through'); ?></span>
                                                ...
                                                <table class="printablea4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right ipdbilltable">
                                                            <h4 style="float: right;font-size: 12px;padding-left: 3px;"> </h4>
                                                        </td>
                                                        <td class="text-right ipdbilltable">
                                                    ...
                                                    <tr>
                                                        <th><?php echo $this->lang->line('tax_cgst') . " (" . $currency_symbol . ")"; ?></th>
                                                        <td class="text-right ipdbilltable">
                                                            <h4 style="float: right;font-size: 12px;padding-left: 3px;"> </h4>
                                                        </td>
                                                        <td class="text-right ipdbilltable">
                                                            <input type="text" placeholder="Tax amount" name="tax_cgst" value="0" id="tax_cgst" style="width: 85%; float: right" class="form-control"/>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <th><?php echo $this->lang->line('tax_sgst') . " (" . $currency_symbol . ")"; ?></th>
                                                        <td class="text-right ipdbilltable">
                                                            <h4 style="float: right;font-size: 12px;padding-left: 3px;"> </h4>
                                                        </td>
                                                        <td class="text-right ipdbilltable">
                                                            <input type="text" placeholder="Tax amount" name="tax_sgst" value="0" id="tax_sgst" style="width: 85%; float: right" class="form-control"/>
                                                        </td>
                                                    </tr>
...
<script>
            function getmedicine_name(id, rowid) {
                var medcatid = $("#medicine_category_id_" + rowid);
                var med_cat_id = medcatid.val();
                // alert(rowid);
                // alert(medcatid.val());
                // alert(id);
                var div_data = "";
                // alert("purchase medicine")
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {medicine_category_id: med_cat_id,search_type:id},
                    dataType: 'json',
                    success: function (res) {
                        $.each(res, function (i, obj)
                        {
                            ...
                            var sel = "";
                            div_data += "<option value=" + obj.id + ">" + obj.medicine_name + " " + obj.medicine_composition +"</option>";
                        });
            ...
            function getmedicine_name_to_push_stock(id, rowid) {
                var medcatid = $("#medicine_category_id_" + rowid);
                var med_cat_id = medcatid.val();
                // alert(rowid);
                // alert(medcatid.val());
                ...
                $('#medicine_name' + rowid).select2("val", 'l');
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/pharmacy/get_medicine_name_to_push_stock',
                    type: "POST",
                    data: {medicine_category_id: med_cat_id,search_type:id},
                    dataType: 'json',
                    success: function (res) {
            ...
            function get_state_of_supplier(id){
                var supId = id;
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/pharmacy/fromtosupplierstate',
                    type: "POST",
                    data: {id: id},
                    dataType: 'json',
                    success: function (res) {
                        from_sup = res[0].state;
                        to_sup = res[1].state;
                        if(from_sup == to_sup){
                            $('#gst_partition').val('inter');
                        }else{
                            $('#gst_partition').val('outer');
                        }
                    }
                });
            ...
            function addMore() {
                ...
                var div = "<td><select class='form-control' name='medicine_category_id[]' id='medicine_category_id_"+ id +"'><option value='<?php echo set_value('medicine_category_id'); ?>'><?php echo $this->lang->line('select') ?></option><?php foreach ($medicineCategory as $dkey => $dvalue) { ?><option value='<?php echo $dvalue["id"]; ?>'><?php echo $dvalue["medicine_category"] ?></option><?php } ?></select></td><td><select class='form-control' name='search_type[]' id='search_type_"+ id +"' onchange='getmedicine_name_to_push_stock(this.value," + id + ")'><option value='<?php echo set_value('search_type'); ?>'><?php echo $this->lang->line('select') ?></option><?php foreach ($medicineSearchtype as $dkey => $stvalue) { ?><option value='<?php echo $stvalue["id"]; ?>'><?php echo $stvalue["search_type"] ?></option><?php } ?></select></td><td><select class='form-control select2' style='width:100%' name='medicine_name[]' onchange='getmedicinedetailstoPushStock(this.value," + id + ")' id='medicine_name" + id + "' ><option value='<?php echo set_value('medicine_name'); ?>'><?php echo $this->lang->line('select') ?></option></select><input type='hidden' id='medicine_id" + id + "' name='medicine_id[]'><input type='hidden' id='medicine_quantity" + id + "' name='medicine_quantity[]'></td><td><select class='form-control batch_no select3' style='width:100%' id='batchno" + id + "' name='batch_no[]' onchange='getmedicinedetailstoPushStockById(this.value," + id + ")'><option value=''><?php echo $this->lang->line('select'); ?></option></select></td><td><input type='text' name='expiry_date[]' id='expiry" + id + "' class='form-control expiry_date'></td><td><input type='text' name='mrp[]' id='mrp" + id + "' class='form-control mrp' readonly></td><td><input type='text' name='batch_amount[]' id='batch_amount" + id + "' class='form-control mrp' readonly></td><td><input type='text' name='sale_rate[]' id='sale_price" + id + "' class='form-control sale_rate' readonly></td><td><input type='text' name='packing_qty[]' id='packing_qty" + id + "' class='form-control packing_qty' readonly></td><td><div class='input-group'><input type='text' name='quantity[]' onchange='multiply(" + id + ")' onfocus='getQuantity(" + id + ")' id='quantity" + id + "' class='form-control text-right'></div></td><td><input type='text' onchange='multiply(" + id + ")' name='purchase_price[]' id='purchase_price" + id + "'  class='form-control text-right' readonly></td><td><div class=''><div class='input-group'><input type='text' onchange='multiply(" + id + ")' class='form-control right-border-none'  name='purchase_tax[]' id='purchase_tax" + id + "'  autocomplete='off' readonly><span class='input-group-addon '> %</span></div></div></td><td><input type='text' name='amount[]' id='amount" + id + "'  class='form-control text-right'></td>";
//na
            ...
            function addTotal() {
                ...
                var gst_partition = $("#gst_partition").val();
                if(gst_partition == 'inter'){
                    var divtwo = ((tax_amount/2).toFixed(2));
                    console.log(divtwo);
                    $("#tax").val(0);
                    $("#tax_cgst").val(divtwo);
                    $("#tax_sgst").val(divtwo);
                ...
                var y = parseFloat(total) + parseFloat(tax) + parseFloat(tax_cgst) + parseFloat(tax_sgst);
                var net_amount = parseFloat(total) + parseFloat(tax) + parseFloat(tax_cgst) + parseFloat(tax_sgst) - y*(parseFloat(discount/100)); 
            ...
            $(document).ready(function (e) {
                $("#bill").on('submit', (function (e) {
                    ...
                    var rowCount = table.rows.length;
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/pharmacy/addBillSupplierpushStock',
                        type: "POST",
            ...
            function viewDetail(id) {
                alert('get sup details');
                $.ajax({
                    url: '<?php echo base_url() ?>admin/pharmacy/getSupplierDetailsStockpush/' + id,
                    type: "GET",
                    data: {},
                    success: function (data) {
            ...
            function multiply(id) {
                ...
                //na
                var mrp = $('#mrp' + id).val();
                var tax = $('#purchase_tax' + id).val();
                // var sale_price = $('#sale_price' + id).val(mrp);
                // var sale_price = $('#sale_price' + id).val(mrp*(100-tax)/100);

                var med_id = $('#medicine_id' + id).val();
                var med_qty = $('#medicine_quantity' + id).val();
                 if (parseInt(quantity) > parseInt(med_qty)) {
                    errorMsg('Order quantity should not be greater than available quantity');
                    $('#quantity' + id).val('');
                }
                // if(quantity < med_qty){
                //     alert('Quantity entered, exceeds the limit of stock available in stack');
                //     $('#quantity' + id).val('');
                //     // $('#sale_price' + id).val('');
                // }
            }
            ...
            // function getmedicinedetailstoPushStock(id, rowid) {
            //     $.ajax({
            //         type: "POST",
            //         url: base_url + "admin/pharmacy/getmedicinedetailstopushStocks",
            //         data: {'pharmacy_id': id},
            //         dataType: 'json',
            //         success: function (res) {
            //              if (res) {
            //                 console.log(res);
            //                 $('#purchase_tax'+ rowid).val(res.vat);
            //                 $('#medicine_id'+ rowid).val(res.mbdId);
            //                 $('#medicine_quantity'+ rowid).val(res.available_quantity);

            //                 $('#mrp'+ rowid).val(res.mrp);
            //                 $('#batch_amount'+ rowid).val(res.units_per_shipper_pack);
            //                 $('#packing_qty'+ rowid).val(res.unit_packing);
            //                 $('#sale_price'+ rowid).val(res.sale_price);
            //                 $('#purchase_price'+ rowid).val(res.purchase_price);
            ...
            // }
             ...
             function getmedicinedetailstoPushStock(id, rowid) {
                // alert(id);
                var batch_no= $(this).closest('tr').find('.batch_no');
                // alert(batch_no);
                $.ajax({
                type: "POST",
                url: base_url + "admin/pharmacy/getBatchNoListtopushstocks",
                data: {'pharmacy_id':id},
                dataType: 'json',
                 async: false,
                   beforeSend: function() {
            ...
            success: function (res) { 
                ...
                $.each(res, function (i, obj)
                {
                    ...
                    //             sel = "selected";
                    //         }
                    // div_data += "<option value=" + obj.mbdId + " " + sel + ">" + obj.batch_no + "</option>";

                     var sel = "";
                            if (rowid == obj.batch_no) {
                                sel = "selected";
                            }
               ...
               // batch_no.select2("val", rowid);
              $('#batchno'+ rowid).html(div_data);
            }
        });
            ...
            function getmedicinedetailstoPushStockById(id, rowid){
                // alert(id);
                // alert(rowid);
                 $.ajax({
                    type: "POST",
                    url: base_url + "admin/pharmacy/getmedicinedetailstopushStocks",
                    data: {'medicine_batch_details_id': id},
                    dataType: 'json',
                    success: function (res) {
                         if (res) {
                            console.log(res);
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/pharmacy/getpharmacypurchaseDatatableStockPush',[],[],100,
            [
...
<script type="text/javascript">
    ...
    function printData(id) {
        ...
        $.ajax({
            url: base_url + 'admin/pharmacy/getSupplierDetailsStockpush/' + id,
            type: 'POST',
