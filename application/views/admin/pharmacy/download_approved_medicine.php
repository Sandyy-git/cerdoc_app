                        ...
                        <table class="table table-striped table-bordered table-hover ajaxlist " cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('medicines_stock'); ?>">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo $this->lang->line('hsn_code'); ?></th> 
                                    <th><?php echo $this->lang->line('patient_billing_rate'); ?></th>
                                    <th><?php echo $this->lang->line('discount_to_patients'); ?></th>
                                    <th><?php echo $this->lang->line('units_per_shipper_pack'); ?></th>
                                    <th><?php echo $this->lang->line('medicine_group'); ?></th>
                                    <th><?php echo $this->lang->line('dosage_form'); ?></th>
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/pharmacy/getpharmacyDatatableDownload',[],[],100,[
