            ...
            <div class="col-md-12">
                <div class="box box-primary"> 
                    <div class="box-header with-border">
                        ...
                        <?php } else { ?>
                            <h3 class="box-title titlefix"><?php echo $this->lang->line('receive_order'); ?></h3>
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-striped table-bordered table-hover ajaxlist" data-export-title="<?php echo $this->lang->line('opd_patient'); ?>">
                                <thead>
                                    ...
                                    <!-- <th><?php echo $this->lang->line('pres_received_by') ?></th> -->
...
<!-- MODAL FOR SHOW PRES AND MAUAL PRES-->
...
( function ( $ ) {
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/patient/getreceiveorderdatatable',[],[],100);
    });
} ( jQuery ) )
</script>
<!-- //========datatable end===== -->
