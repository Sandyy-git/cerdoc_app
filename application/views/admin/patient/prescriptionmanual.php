        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="">
                    ...
                    <hr style="height: 1px; clear: both;margin-bottom: 10px; margin-top: 10px" />  
                 <?php if($result["mp_image"] != ''){
                    ?>
                    <!-- manual presc image path added in web -->
                        <div class="pprinta4">
                        <a href="<?php echo base_url().'/uploads/pres/'.$result['mp_image']; ?>" target="_blank" style="width:100%;height:100px"> 
                        <img src="<?php echo base_url().'/uploads/pres/'.$result['mp_image']; ?>"  class="img-responsive" style="width:100%;height:400px">
                        </a>
