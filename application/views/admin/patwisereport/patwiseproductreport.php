            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('patientwise_product_report') ?></h3>
                                    ...
                                    <form id="transaction_form" action="" method="post" class="">
                                        ...
                                        <div class="col-sm-6 col-md-3" >
                                           <div class="form-group">
                                                <label><?php echo $this->lang->line('staff_locality'); ?></label><small class="req"> *</small>
                                                <select class="form-control" name="localityid"  id="search_type_select" onchange="showdoctors(this.value)">
                                                <option value=""><?php echo $this->lang->line('select')?></option> 
                                                    <?php foreach ($locality as $key => $search) { ?>
                                                        <option value="<?php echo $search['id'] ?>" <?php
                                                            ?>><?php echo $search['locality'] ?></option>
                                                        <?php }?>
                                                </select>
                                                <span class="text-danger" id="error_search_type"><?php echo form_error('localityid'); ?></span>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-sm-6 col-md-3" >
                                           <div class="form-group">
                                                ...
                                                <select class="form-control" name="doctorid[]"  id="doctorid" multiple>
                                                <option value=""><?php echo $this->lang->line('select')?></option> 
                                                </select>
                                                <span class="text-danger" id="error_search_type"><?php echo form_error('doctorid[]'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-3" >
                                           <div class="form-group">
                                                ...
                                                <select class="form-control" name="patientid"  id="patient_id">
                                                <option value=""><?php echo $this->lang->line('select')?></option> 
                                                    <?php foreach ($patient as $key => $search) { ?>
                                                        <option value="<?php echo $search['id'] ?>" <?php
                                                            ?>><?php echo $search['patient_fullname'] ?></option>
                                                        <?php }?>
                                                </select>
                                                <span class="text-danger" id="error_search_type"><?php echo form_error('patientid'); ?></span>
                                            </div>
                                        </div>
            ...
            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-right"><?php echo $this->lang->line('tax_cgst'); ?></th>
                        <th class="text-right"><?php echo $this->lang->line('tax_sgst'); ?></th>
                        ...
                        <!-- <th class="text text-right noExport"><?php echo $this->lang->line('purchase'); ?></th> -->
                    </tr>
                </thead>
                <tbody>
                    <?php 
                ...
                <tr>
                    ...
                    <td><?php echo $dt_value['product_id'] ?></td>
                    <td><?php echo $dt_value['product_name'] ?></td>
                    <td><?php echo $dt_value['company_name']; ?></td>
                    <td><?php echo $dt_value['doctor'] ?></td>
                    
                    <td><?php echo $dt_value['patient']; ?></td>
                    <td><?php echo $dt_value['quantity']; ?></td>
                     <td><?php echo $dt_value['valuep']; ?></td>
                    <td class="text text-right"><?php echo amountFormat($dt_value['tax_cgst']); ?></td>
                     <td class="text text-right"><?php echo amountFormat($dt_value['tax_sgst']); ?></td>
                      <td class="text text-right"><?php echo amountFormat($dt_value['tax']); ?></td>

                    <td class="text text-right"><?php echo amountFormat($dt_value['purchase_amount']); ?></td>
...
<script type="text/javascript">
    ...
    function showdoctors(id){
           ...
           $.ajax({
                type: "POST",
                url: base_url + "admin/staff/getDoctorbyLocId",
                data: {'localityid':id},
                dataType: 'json',
                 async: false,
                   beforeSend: function() {
                  doctors.html("<option value=''><?php echo $this->lang->line('loading') ?></option>");
                },
            success: function (res) { 
                ...
                {
                   div_data += "<option value = '" + obj.id + " '>" + obj.name + '(' +  obj.employee_id + ')' + " </option>";
                });
              $('#doctorid').html(div_data);
            }
        });
    ...
    $(document).on('click','.daily_collection',function(e){
       ...
       var form = $(this);
        $.ajax({
            url: baseurl+'admin/purchase_report/getpurchasetransactionbydate',
            type: "POST",
