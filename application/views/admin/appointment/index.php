...
function getBed(bed_group, bed = '', active, htmlid = 'bed_no') {
    ...
    function viewreschedule(id){
      ...
      // alert(id);                            id from appointment table
      $.ajax({
        ...
        success: function (data) {
          ...
          $("#edit_appointment_status").val(data.appointment_status);     //this is the appointment status
...
( function ( $ ) {
  'use strict';
  $(document).ready(function () {          //here is the data getting and appending to datatable
