            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"></i><?php echo $this->lang->line('vp_report'); ?></h3>
                    </div>
                    <div class="box-body">
                         ...
                         <table class="table table-hover table-striped table-bordered allajaxlist" data-export-title="<?php echo $this->lang->line('live_consultation_report'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('pharmacy'); ?></th>
                                        ...
                                        <th><?php echo $this->lang->line('sum_up'); ?></th>
        ...
        //formData.append('search', 'search_filter');
          $.ajax({
            ...
            success: function (data) {
                ...
                initDatatable('allajaxlist','admin/zoom_conference/valuepointreport',data.param,[],100,[{"bSortable": false, "aTargets": [0,8] }]);
                }
            }
        });
