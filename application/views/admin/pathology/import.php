                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('import_test', 'can_view')) { ?>       
                                <a href="<?php echo site_url('admin/pathology/exportformat') ?>">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    foreach ($fields as $key => $value) {
                                        ...
                                        $add = "";
                                        if (($value == "parameter") || ($value == "range") || ($value == "unit") || ($value == "description") ) {
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 pt20">
                                    ...
                                    <button type="submit" class="btn btn-info btn-sm pull-right"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_test'); ?></button>
                                </div>     
