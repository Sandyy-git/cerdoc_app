            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <!-- newly added part, need to add from main pathology module from super admin -->
                            <!-- <?php if ($this->rbac->hasPrivilege('import_test', 'can_view')) {    ?>                  
                                <a data-toggle="modal" href="<?php echo base_url(); ?>admin/pathology/import" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_test'); ?>
                                </a>
                            <?php } ?> -->
                        <!-- newly added part -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <div class="modalicon">
                    <div id='edit_delete'>
                        <!-- <?php if($can_edit == 'yes'){ if ($this->rbac->hasPrivilege('pathology_test', 'can_edit')) {?>
...
//pathology edit check changes some parameter 
    ...
    $.ajax({
            ...
            dataType: 'JSON',
            success: function (data) {
                // console.log(data.can_edd.can_edit);
                $('#edit_delete').html('');
                $('#viewModal .modal-body').html(data.page);
                $('#viewModal').modal('show');
                if(data.can_edd.can_edit == 'yes'){
