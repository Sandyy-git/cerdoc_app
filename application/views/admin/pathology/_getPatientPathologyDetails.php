...
if($report_value->collection_specialist_staff_employee_id != ""){
    ?>
                                  ...
                                  <!-- na for barcode -->
                                  <a href='javascript:void(0)'  data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>' data-record-id='<?php echo $report_value->id;?>' class='btn btn-default btn-xs add_barcode' data-toggle='tooltip' title='<?php echo $this->lang->line("add_edit_barcode"); ?>'><i class='fa fa-barcode'></i></a>  
