...
$roles  = $this->role_model->getSystemRoles();
?>
            ...
            <div class="col-md-3">
                <div class="box box-primary" >
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('staff_roles_name'); ?></label><small class="req"> *</small>
                                <select class="form-control multiselect2" style="width: 100%" name='rolesStaff[]' multiple id="rolesStaff">
