...
//First Overview while onloading
    public function profile()
    {
        ...
        //first overview while onloading
        $data['patientdetails'] = $this->patient_model->getpatientoverview($id,null);
        // var_dump($data['patientdetails']); die;
    ...
    public function visitdetails($opd_details_id)
    {
        ...
        if (!empty($opd_details_id)) {
            ...
            // var_dump($data["charges_detail"]); die;
            ...
            $data['patientdetails']            = $this->patient_model->getpatientoverviewbycaseid($result['case_reference_id']);//from opd_details
            ...
            $data['recent_record_count'] = 5;      //recent record count
...
//model shift
        $doctors                     = $this->patient_model->getEmployeeByRoleID(3);
        ...
        if ($this->form_validation->run() == false) {    
                ...
                $payment_data = array(
                    ...
                    'paid_amount'    => 0,       //530
                    'charge_id'      => 1,  //at first while adding transation_id payment_mode null
                ...
                $transaction_array = array(
                    'amount'         => 0,     //here amount is going as 0 while adding appointment
                    'patient_id'     => $this->session->userdata("patient")["patient_id"],
                    ...
                    'received_by'    => $this->input->post('doctor'),
                );
                //upto appointment table only just collect array data given below
                ...
                $this->onlineappointment_model->saveAppointmentPayment($payment_data, $transaction_array);   //save to both appointment_payment and transaction table
            ...
            $this->session->set_flashdata("error_msg",$this->lang->line("error_message"));
            $json_array = array('status' => '0', 'msg' => "already this slot is booked,try to book some other slot");
            echo json_encode($json_array);            
        }
    }
    }
