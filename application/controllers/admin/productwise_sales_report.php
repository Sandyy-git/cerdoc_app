...
class Productwise_sales_report extends Admin_Controller
{
    ...
    public function productwisesalesreport()
    {
        ...
        $this->session->set_userdata('sub_menu', 'admin/sales/productwisesalesreport');
        $data['title'] = 'title';
        ...
        if ($this->form_validation->run() == false) {
            ...
            if($role_id == 73){    //FOR CENTRAL PHARMA ADMIN
                $reportdata = $this->sales_model->getProductwiseSalesReporttoCP($date_from, $date_to);
            }elseif($role_id == 7){    //FOR SUPER ADMIN
                $reportdata = $this->sales_model->getProductwiseSalesReporttoCP($date_from, $date_to);
            }else{
                $reportdata = $this->sales_model->getProductwiseSalesReport($date_from, $date_to,$arry_pha);
            }
            // echo "<pre>";
        ...
        $this->load->view('admin/sales/productwisesalesreport', $data);
