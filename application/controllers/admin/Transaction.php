...
class Transaction extends Admin_Controller
{
    ...
    public function transactionreport()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $staffId = $this->customlib->getStaffID();    //sa - 1,tri - 94,next - 104
            ...
            $reportdata = $this->transaction_model->getTransactionBetweenDateLoginwise($date_from, $date_to, 'payment',$r_id,$transstaffArray);

            // echo "<pre>";
            // print_r(json_decode($staffRoleId)->id); die;
    ...
    public function gettransactionbydate()
    {
        ...
        $result         = $this->transaction_model->getTransactionBetweenDateLoginwise($date, $date, 'payment',$r_id,$transstaffArray);
