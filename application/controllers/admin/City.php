...
class City extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $city    = $this->localitycity_model->getCity();
        ...
        // }
        $data["city"]   = $city;
        $staffLocality         = $this->localitycity_model->getLocalityCity();
        $data["localityCity"] = $staffLocality;
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $array = array('status' => 'fail', 'error' => $msg, 'message' => '');
                ...
                $this->localitycity_model->addLocalityCity($data);
    ...
    public function delete($id)
    {
        ...
        $this->localitycity_model->delete($id);
