    ...
    public function salesreport()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if($role_id == 73){    //FOR CENTRAL PHARMA ADMIN
                $reportdata = $this->sales_model->getTransactionBetweenDateLoginwisetoCp($date_from, $date_to);
            }elseif($role_id == 7){    //FOR SUPER ADMIN
                $reportdata = $this->sales_model->getTransactionBetweenDateLoginwisetoCp($date_from, $date_to);
            }else{
                $reportdata = $this->sales_model->getTransactionBetweenDateLoginwise($date_from, $date_to,$arry_pha);
            }  
            // echo "<pre>";
        ...
        $this->load->view('admin/sales/salesreport', $data);
