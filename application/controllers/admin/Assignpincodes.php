...
class Assignpincodes extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $pincodes    = $this->assignpincodes_model->getStaffPin();
        ...
        if ($this->form_validation->run()) {
            ...
            $this->load->view("admin/staff/assignpincodes", $data);
    ...
    public function add()
    {
        $staffpincodeid = $this->input->post("staffpincodeid");
        ...
        if ($this->form_validation->run() == false) {
            ...
            $array = array('status' => 'fail', 'error' => $msg, 'message' => '');
                ...
                if (!empty($staffpincodeid) && $staffpincodeid != 0) {
                    $data['id'] = $staffpincodeid;
                }

                if ($this->assignpincodes_model->check_pincode_exists($_POST['pincode'])) {
                    $msg = array(
    ...
    public function addPincodestoDis()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $array = array('status' => 'fail', 'error' => $msg, 'message' => '');
                ...
                if ($this->assignpincodes_model->check_pincode_exists_dis($_POST['pincode'])) {
                    $msg = array(
                        'pincode' => 'Pincode Exists',        
                    );
                    $array = array('status' => 'fail', 'error' => $msg, 'message' => '');
    ...
    public function delete($id)
    {
        ...
        $this->assignpincodes_model->delete($id);
    ...
    public function get_data($id)
    {
        ...
        $result = $this->assignpincodes_model->getStaffpcode($id);
