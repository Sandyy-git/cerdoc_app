...
class Productwise_purchase_report extends Admin_Controller
{
    ...
    public function productwisepurchasereport()
    {
        ...
        $this->session->set_userdata('sub_menu', 'admin/purchase/productwisepurchasereport');
        $data['title'] = 'title';
        ...
        if ($this->form_validation->run() == false) {
            ...
            if($role_id == 73){    //FOR CENTRAL PHARMA ADMIN
                $reportdata = $this->purchase_model->getProductwisePurchaseReporttoCP($date_from, $date_to);
            }elseif($role_id == 7){    //FOR SUPER ADMIN
                $reportdata = $this->purchase_model->getProductwisePurchaseReporttoCP($date_from, $date_to);
            }else{
                $reportdata = $this->purchase_model->getProductwisePurchaseReport($date_from, $date_to,$loginuserId);
            }
        ...
        $this->load->view('admin/purchase/productwisepurchasereport', $data);
